...
//By using closures we can pass the variables down, the variable 'internal' was declared inside of the function that's why we still have access to it 
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach(animal => {
      ...
      const displayName = `name: ${animal_name}, scientific: ${scientific_name}`
